    ...
    <div className={`min-h-screen bg-slate-50 text-slate-800 font-sans pb-20 ${themeMode==='sunny'?'theme-sunny':''} ${themeMode==='rainy'?'theme-rainy':''} ${themeMode==='sea'?'theme-sea':''}`}>
      ...
      {showSettings && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in">
          <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom-10">
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Scorecard removed from Settings to simplify the modal (use Scorecard button in header) */}
